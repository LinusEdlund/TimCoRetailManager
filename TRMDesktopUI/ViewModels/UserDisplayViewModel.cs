...
namespace TRMDesktopUI.ViewModels
{
    public class UserDisplayViewModel : Screen
    {
        ...
        private readonly IUserEndpotin _userEndpotint;
        ...
        public UserDisplayViewModel(StatusInfoViewModel status, IWindowManager window, IUserEndpotin userEndpotint)
        {
            _status = status;
            _window = window;
            _userEndpotint = userEndpotint;
        }
        ...
        {
            var userList = await _userEndpotint.GetAll();
        ...
        {
            await _userEndpotint.RemoveUserFromRole(SelectedUser.Id, SelectedUserRole);
